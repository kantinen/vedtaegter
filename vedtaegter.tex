...
\def\vedtagsdato{den 21. december 2017}
...
\item Foreningens ledes af en bestyrelse, der består af en formand,
kasserer, samt seks til femten menige bestyrelsesmedlemmer.

\item Bestyrelsen konstituerer sig selv, dvs. fastlægger selv hvilke poster,
...
\item \label{Opløsning efter ønske fra foreningens medlemmer}Foreningen kan 
opløses på følgende måde: Beslutningen skal foretages
...
f.eks. ved flytning}
\item \label{Opløsning som følge af opsigelse af nuværende lokaler,
f.eks. ved flytning}
...
\item  Ved afvikling af kantineforeningens vil følgende gælde:
...
vedtaegter/vedtaegter.tex at master · kantinen/vedtaegter 
