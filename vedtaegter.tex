...
\def\vedtagsdato{den 17. marts 2026}
...
\newenvironment{stykenum}{
  \begin{enumerate}[%
    label=Stk.~\arabic*., ref=\thesection~Stk.~\arabic*, start=1]
}{\end{enumerate}}
...
\item \label{bestyrelsen-ledelse} Foreningens daglige ledelse varetages af en
bestyrelse, som udgøres ex officio af de til enhver tid valgte medlemmer af
RusKursusGruppens bestyrelse (som minimum en formand, næstformand og kasserer),
medmindre generalforsamlingen beslutter andet. Bestyrelsen leder foreningen i
overensstemmelse med Kantineforeningens vedtægter. Bestyrelsens øvrige
konstitution og beslutningsdygtighed følger RusKursusGruppens vedtægter.

\item Medlemskab af Kantineforeningen kræver ikke medlemskab af
RusKursusGruppen.

\item Denne bestyrelsesstruktur er valgt for at sikre foreningens drift.
Generalforsamlingen kan til enhver tid ændre vedtægterne jf.
\ref*{vedtaegtsaendringer} for at vælge en selvstændig bestyrelse jf.
\ref*{generalforsamling-bestyrelse} og \ref*{afstemning}.
...
\item Ordinær generalforsamling afholdes én gang årligt i marts.
...
\item \label{generalforsamling-bestyrelse} Såfremt der er medlemmer der ønsker
...
hvilke(n) post(er) han/hun stiller op til (forperson, kasserer eller
...
\item Forperson og kasserer vælges direkte af generalforsamlingen ved simpelt
...
der fik flest stemmer i første runde. Forpersonen vælges først. Dernæst
...
\section{Tegning}
\begin{stykenum}
\item Foreningen tegnes af formand og kasserer (jf. \ref*{bestyrelsen-ledelse}).

\item Bestyrelsen er økonomisk ansvarlig.
...
22. april 2009, 6. juni 2012, 4. december 2017, 21. marts 2023, 18.
marts 2025 samt den 17. marts 2026.}
